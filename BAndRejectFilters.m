...
for i = 1:population
    errTaught(i)=BandRejectErrorFxn(hTaught(i,:));
end
...
for i =1:population
   ...
   if BandRejectErrorFxn(hval)>BandRejectErrorFxn(hval2)
...
for i = 1:population
    errLearned(i)=BandRejectErrorFxn(hLearned(i,:));
end
