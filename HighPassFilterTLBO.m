...
for i = 1:population
    errTaught(i)=HighPassErrorFunc(hTaught(i,:));
end
...
for i =1:population
   ...
   if HighPassErrorFunc(hval)>HighPassErrorFunc(hval2)
...
for i = 1:population
    errLearned(i)=HighPassErrorFunc(hLearned(i,:));
end
...
title(' High Pass Filter Design Using TLBO Optimization ');
